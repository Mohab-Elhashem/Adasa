            ...
            <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden bg-[#0a0a0a]">
                ...
                <div className="relative text-center px-4 max-w-lg mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                        <Link
                            to="/"
                            className="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors inline-flex items-center justify-center gap-2"
                        >
                            <svg
                                className="w-5 h-5"
                                fill="none"
                        ...
                        <Link
                            to="/blog"
                            className="px-6 py-3 bg-[#161616] border border-[#262626] hover:border-orange-500/50 text-white font-semibold rounded-xl transition-colors inline-flex items-center justify-center gap-2"
                        >
                            <svg
                                className="w-5 h-5"
                                fill="none"
                    ...
                    <div className="pt-8 border-t border-[#262626]">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-sm pb-5">
                            <Link
                                to="/blog"
